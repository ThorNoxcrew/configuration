...
mccScript {
    ...
    playerNPC(
        ...
        pointList += Transform(351.5, 33.0, 487.5)
        pointList += Transform(351.5, 31.5, 407.5)
        pointList += Transform(348.5, 31.5, 406.5)
        pointList += Transform(325.0, 31.5, 406.5)
        pointList += Transform(324.5, 33.5, 420.5)
        pointList += Transform(324.5, 33.5, 443.0)
        pointList += Transform(321.5, 35.0, 458.0)
        pointList += Transform(321.5, 34.5, 483.5)
