...
mccScript {
    ...
    playerNPC(
        ...
        pointList += Transform(320.5, 34.0, 443.0)
        pointList += Transform(336.0, 33.0, 443.0)
        pointList += Transform(350.0, 31.5, 443.5)
        pointList += Transform(351.0, 31.5, 438.5)
        pointList += Transform(351.0, 31.5, 422.5)
        pointList += Transform(356.5, 31.5, 421.0)
        pointList += Transform(370.5, 34.0, 420.0)
